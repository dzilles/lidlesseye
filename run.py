...
from spider import PublicSandboxSpider
from vault import load_env_from_vault


def parse_args():
    parser = argparse.ArgumentParser(description="Run Project LidlessEye Phase 2 pipeline.")
    parser.add_argument(
        "--project-file",
...
def main():
    ...
    process = CrawlerProcess(
        settings={
            "ITEM_PIPELINES": {
                "pipelines.LLMExtractionPipeline": 300,
                "pipelines.Neo4jStoragePipeline": 400,
            },
